...
//                    echo __FUNCTION__, ": case 0x21 error on datlen $datLen<br />\n";
					return false;
				}
				$datLen += $len;
				break;
...
//                    echo __FUNCTION__, ": case 0x2c this->m_gih->load error on datlen $datLen<br />\n";
					return false;
				}
...
//                    echo __FUNCTION__, ": case 0x2c this->m_data error on datlen $datLen<br />\n";
					return false;
				}
				$data = substr($data, $len);
				$datLen += $len;
			...
			case 0x3B: // EOF
//                echo __FUNCTION__, ": case 0x3b error on datlen $datLen<br />\n";
			default:
//                echo __FUNCTION__, ": case default error on datlen $datLen, b == $b<br />\n";
				return false;
			}
		}
//        echo __FUNCTION__, ": after while(true) error on datlen $datLen<br />\n";
		return false;
	}
...
//            echo __FUNCTION__, ": no filehandle for $lpszFileName<br />\n";
			return false;
		}
...
//            echo __FUNCTION__, ": error on this->m_gfh->load<br />\n";
			return false;
		}
...
//                echo __FUNCTION__, ": error on this->m_img->load<br />\n";
				return false;
			}
