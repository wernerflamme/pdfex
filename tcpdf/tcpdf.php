...
//    image scale factor;
//    includes methods to parse and print some XHTML code, supporting the following elements: 
//    h1, h2, h3, h4, h5, h6, b, u, i, a, img, p, br, strong, em, font, blockquote, li, ul, ol, hr, td, th, tr, table, sup, sub, small;
//    includes a method to print various barcode formats using an improved version of 
//    "Generic Barcode Render Class" by Karim Mribti (http://www.mribti.com/barcode/) (require GD library: http://www.boutell.com/gd/);
//    defines standard Header() and Footer() methods.
//
// Added function _parsegif from HTML2FPDF 
// 2002-08-09 Werner Flamme <w.flamme@web.de>
//============================================================+
	...
	*/
	class TCPDF {
		...
		*/
		 ...
		 * Possible values are (case insensitive):<ul><li>P or Portrait (default)</li><li>L or Landscape</li></ul>
		 * @param string $unit User measure unit. 
		 * Possible values are:<ul><li>pt: point</li><li>mm: millimeter (default)</li><li>cm: centimeter</li><li>in: inch</li></ul><br />
		 ...
		 * @param mixed $format The format used for pages. It can be either one of the following values 
		 * (case insensitive) or a custom format in the form of a two-element array containing the width and the height 
		 * (expressed in the unit given by unit).
		 * <ul><li>4A0</li><li>2A0</li><li>A0</li><li>A1</li><li>A2</li><li>A3</li><li>A4 (default)</li><li>A5</li><li>A6</li><li>A7</li><li>A8</li><li>A9</li><li>A10</li> 
		 * <li>B0</li><li>B1</li><li>B2</li><li>B3</li><li>B4</li><li>B5</li><li>B6</li><li>B7</li><li>B8</li><li>B9</li><li>B10</li>
		 * <li>C0</li><li>C1</li><li>C2</li><li>C3</li><li>C4</li><li>C5</li><li>C6</li><li>C7</li><li>C8</li><li>C9</li><li>C10</li>
		 * <li>RA0</li><li>RA1</li><li>RA2</li><li>RA3</li><li>RA4</li><li>SRA0</li><li>SRA1</li><li>SRA2</li><li>SRA3</li><li>SRA4</li>
		 * <li>LETTER</li><li>LEGAL</li><li>EXECUTIVE</li><li>FOLIO</li></ul>
		...
		*/
        ...
        function _parsegif($file) //EDITEI - GIF support is now included Modified by Renato A.C. [html2fpdf.sf.net]
        { 
            //Function by Jérôme Fenal
            require_once(dirname(__FILE__) . '/gif.php'); //GIF class in pure PHP from Yamasoft (http://www.yamasoft.com/php-gif.zip)
        
            $h=0;
            $w=0;
            $gif=new CGIF();
            //echo '<pre>' . print_r($gif, true) . "</pre>\n";
            if (!$gif->loadFile($file, 0)) {
              if ($file == K_BLANK_IMAGE)
                $this->Error("GIF parser: unable to open file $file");
              else {
                return $this->_parsejpg(K_BLANK_IMAGE);
              }
            } // if (!$gif->loadFile($file, 0))
			...
			switch($tag) {
				...
				case 'img': {
					if(isset($attr['src'])) {
						...
						$attr['src'] = str_replace(K_PATH_URL, K_PATH_CACHE, $attr['src']);
						if(!isset($attr['width'])) {
							$attr['width'] = 0;
						}
