...
Misc. Observations:
- CSS + align = bug! (?)
OBS1: para textos de mais de 1 p�ina, talvez tenha que juntar varios $texto_artigo
...
require_once(RELATIVE_PATH . 'fpdf.class.php');
require_once(RELATIVE_PATH . 'htmltoolkit.inc.php');

class HTML2FPDF extends cFPDF
{
//internal attributes
var $HREF; //! string
var $pgwidth; //! float
...
//! @return An object (a class instance)
	...
	$this->cFPDF($orientation,$unit,$format);
