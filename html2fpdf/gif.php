...
//echo __FUNCTION__, ' case 0x21 error on line ', __LINE__, "<br />\n";
					return false;
				}
				$datLen += $len;
				break;
...
//echo __FUNCTION__, ' this->m_gih->load error on line ', __LINE__, "<br />\n";
					return false;
				}
...
//echo __FUNCTION__, ' this->m_data error on line ', __LINE__, "<br />\n";
					return false;
				}
				$data = substr($data, $len);
				$datLen += $len;
			...
			case 0x3B: // EOF
//echo __FUNCTION__, ' case 0x3b error on line ', __LINE__, "<br />\n";
			default:
//echo __FUNCTION__, ' case default error on line ', __LINE__, "<br />\n";
//echo __FUNCTION__, "b=$b<br />\n";
				return false;
			}
		}
		return false;
...
class CGIF
{
	...
	{
		if($iIndex < 0) {
//echo __FUNCTION__, ' iIndex error on line ', __LINE__, "<br />\n";
			return false;
		}
		// READ FILE
		if(!($fh = @fOpen($lpszFileName, "rb"))) {
//echo __FUNCTION__, ' fopen error on line ', __LINE__, "<br />\n";
			return false;
		}
...
//echo __FUNCTION__, ' this->m_gfh->load error on line ', __LINE__, "<br />\n";
			return false;
		}
...
//echo __FUNCTION__, ' this->m_img->load error on line ', __LINE__, "<br />\n";
				return false;
			}
